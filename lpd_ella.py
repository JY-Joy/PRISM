...
from models import MLP, PromptResampler, PromptDecomposer
...
def main():
    ...
    tokenizer_t5 = AutoTokenizer.from_pretrained("/scratch4/mdredze1/jhuan236/zoo/ella/models--google--flan-t5-xl--text_encoder")
    text_encoder_t5 = T5EncoderModel.from_pretrained("/scratch4/mdredze1/jhuan236/zoo/ella/models--google--flan-t5-xl--text_encoder")
    ...
    if args.ckpt is not None:
        ella_sd = load_file("/scratch4/mdredze1/jhuan236/zoo/ella/ella-sd1.5-tsc-t5xl.safetensors", device="cpu")
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(*trainable_module):
                ...
                # # Regularization 1: sub-prompt norm
                batch_decomposed_hidden_states = torch.stack(token_hidden_states,dim=1).mean(dim=2)   # [B, num_component, mean(num_token), D]
